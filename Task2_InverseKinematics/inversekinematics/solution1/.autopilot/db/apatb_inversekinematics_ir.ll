; ModuleID = '/home/gabris/Documents/inversekinematics/inversekinematics/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_inversekinematics_ir(float* %din, float* %dout) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_inversekinematics_hw(float* %2, float* %3)
...
declare void @apatb_inversekinematics_hw(float*, float*)

define void @inversekinematics_hw_stub_wrapper(float*, float*) #5 {
entry:
  %2 = bitcast float* %0 to [2048 x float]*
  %3 = bitcast float* %1 to [2048 x float]*
  call void @copy_out([2048 x float]* null, [2048 x float]* %2, [2048 x float]* null, [2048 x float]* %3)
  %4 = bitcast [2048 x float]* %2 to float*
  %5 = bitcast [2048 x float]* %3 to float*
  call void @inversekinematics_hw_stub(float* %4, float* %5)
  call void @copy_in([2048 x float]* null, [2048 x float]* %2, [2048 x float]* null, [2048 x float]* %3)
  ret void
}

declare void @inversekinematics_hw_stub(float*, float*)
