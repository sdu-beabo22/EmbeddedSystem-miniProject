...
entity inversekinematics_pow_generic_double_s_pow_reduce_anonymous_namespace_log0_lut_table_ap_fixed_1cud_rom is 
    generic(
             DWIDTH     : integer := 109; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of inversekinematics_pow_generic_double_s_pow_reduce_anonymous_namespace_log0_lut_table_ap_fixed_1cud_rom is 
...
entity inversekinematics_pow_generic_double_s_pow_reduce_anonymous_namespace_log0_lut_table_ap_fixed_1cud is
    generic (
...
architecture arch of inversekinematics_pow_generic_double_s_pow_reduce_anonymous_namespace_log0_lut_table_ap_fixed_1cud is
    component inversekinematics_pow_generic_double_s_pow_reduce_anonymous_namespace_log0_lut_table_ap_fixed_1cud_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    inversekinematics_pow_generic_double_s_pow_reduce_anonymous_namespace_log0_lut_table_ap_fixed_1cud_rom_U :  component inversekinematics_pow_generic_double_s_pow_reduce_anonymous_namespace_log0_lut_table_ap_fixed_1cud_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
