...
#include "motor_controller/srv/detail/get_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const motor_controller::srv::GetPosition_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  motor_controller::srv::GetPosition_Request & ros_message)
{
  // Member: id0
  cdr >> ros_message.id0;
...
{
  auto typed_message =
    static_cast<const motor_controller::srv::GetPosition_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<motor_controller::srv::GetPosition_Request *>(
    untyped_ros_message);
...
{
  return &motor_controller::srv::typesupport_fastrtps_cpp::_GetPosition_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_controller, srv, GetPosition_Request)() {
  return &motor_controller::srv::typesupport_fastrtps_cpp::_GetPosition_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_motor_controller
cdr_serialize(
  const motor_controller::srv::GetPosition_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: position0
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  motor_controller::srv::GetPosition_Response & ros_message)
{
  // Member: position0
  cdr >> ros_message.position0;
...
{
  auto typed_message =
    static_cast<const motor_controller::srv::GetPosition_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<motor_controller::srv::GetPosition_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &motor_controller::srv::typesupport_fastrtps_cpp::_GetPosition_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_controller, srv, GetPosition_Response)() {
  return &motor_controller::srv::typesupport_fastrtps_cpp::_GetPosition_Response__handle;
}
...
{
  return &motor_controller::srv::typesupport_fastrtps_cpp::_GetPosition__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_controller, srv, GetPosition)() {
  return &motor_controller::srv::typesupport_fastrtps_cpp::_GetPosition__handle;
}
