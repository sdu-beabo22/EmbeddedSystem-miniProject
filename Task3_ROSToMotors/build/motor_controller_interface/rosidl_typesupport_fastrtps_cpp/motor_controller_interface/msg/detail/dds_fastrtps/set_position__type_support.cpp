...
#include "motor_controller_interface/msg/detail/set_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const motor_controller_interface::msg::SetPosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<motor_controller_interface::msg::SetPosition *>(
    untyped_ros_message);
...
{
  return &motor_controller_interface::msg::typesupport_fastrtps_cpp::_SetPosition__handle;
}
