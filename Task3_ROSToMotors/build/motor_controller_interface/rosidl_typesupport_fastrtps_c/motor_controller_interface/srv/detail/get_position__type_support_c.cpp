...
#include "motor_controller_interface/srv/detail/get_position__rosidl_typesupport_fastrtps_c.h"
...
#include "motor_controller_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _GetPosition_Request__ros_msg_type = motor_controller_interface__srv__GetPosition_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motor_controller_interface
size_t get_serialized_size_motor_controller_interface__srv__GetPosition_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetPosition_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_motor_controller_interface__srv__GetPosition_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motor_controller_interface
size_t max_serialized_size_motor_controller_interface__srv__GetPosition_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_motor_controller_interface__srv__GetPosition_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motor_controller_interface, srv, GetPosition_Request)() {
...
using _GetPosition_Response__ros_msg_type = motor_controller_interface__srv__GetPosition_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motor_controller_interface
size_t get_serialized_size_motor_controller_interface__srv__GetPosition_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetPosition_Response__ros_msg_type * ros_message = static_cast<const _GetPosition_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_motor_controller_interface__srv__GetPosition_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motor_controller_interface
size_t max_serialized_size_motor_controller_interface__srv__GetPosition_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_motor_controller_interface__srv__GetPosition_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motor_controller_interface, srv, GetPosition_Response)() {
...
// already included above
// #include "motor_controller_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "motor_controller_interface/srv/get_position.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motor_controller_interface, srv, GetPosition)() {
