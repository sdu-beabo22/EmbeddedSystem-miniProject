...
#include "motor_controller_interface/msg/detail/set_position__rosidl_typesupport_fastrtps_c.h"
...
using _SetPosition__ros_msg_type = motor_controller_interface__msg__SetPosition;
...
size_t get_serialized_size_motor_controller_interface__msg__SetPosition(
  const void * untyped_ros_message,
...
static uint32_t _SetPosition__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_motor_controller_interface__msg__SetPosition(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_motor_controller_interface
size_t max_serialized_size_motor_controller_interface__msg__SetPosition(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_motor_controller_interface__msg__SetPosition(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_SetPosition = {
  "motor_controller_interface::msg",
  "SetPosition",
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motor_controller_interface, msg, SetPosition)() {
