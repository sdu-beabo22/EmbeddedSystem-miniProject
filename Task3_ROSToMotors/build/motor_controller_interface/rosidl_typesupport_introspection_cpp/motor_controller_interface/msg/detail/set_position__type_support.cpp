...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetPosition_message_member_array[2] = {
  {
    ...
    offsetof(motor_controller_interface::msg::SetPosition, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_controller_interface::msg::SetPosition, position),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
