...
class Metaclass_GetPosition_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('motor_controller_interface')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_GetPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'motor_controller_interface.srv.GetPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from motor_controller_interface.srv import _get_position
...
class GetPosition(metaclass=Metaclass_GetPosition):
    from motor_controller_interface.srv._get_position import GetPosition_Request as Request
    from motor_controller_interface.srv._get_position import GetPosition_Response as Response
