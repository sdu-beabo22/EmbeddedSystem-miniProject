...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_bram_cntlr_cnt=3,da_zynq_ultra_ps_e_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (led_ctrl1_0,
    led_ctrl2_0,
    led_ctrl3_0,
  ...
  wire [31:0]nn_ctrl_0_o_BRAM_addr;
  wire nn_ctrl_0_o_BRAM_ce;
  wire [31:0]nn_ctrl_0_o_BRAM_din;
  wire [3:0]nn_ctrl_0_o_BRAM_wr;
  wire nn_inference_0_ap_done;
  wire nn_inference_0_ap_idle;
  wire nn_inference_0_ap_ready;
  wire [31:0]nn_inference_0_ap_return;
  wire [6:0]nn_inference_0_input_img_address0;
  wire nn_inference_0_input_img_ce0;
  ...
  design_1_axi_bram_ctrl_0_bram_1 axi_bram_ctrl_0_bram
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(nn_ctrl_0_o_BRAM_addr),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(zynq_ultra_ps_e_0_pl_clk0),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(nn_ctrl_0_o_BRAM_din),
  ...
  design_1_fix_address_0_0 fix_address_0
       (.addr_in(nn_inference_0_input_img_address0),
        .addr_out(fix_address_0_addr_out));
  design_1_nn_ctrl_0_0 nn_ctrl_0
       (.ap_done(nn_inference_0_ap_done),
        .ap_idle(nn_inference_0_ap_idle),
        .ap_ready(nn_inference_0_ap_ready),
        .ap_rst(nn_ctrl_0_ap_rst),
        .ap_start(nn_ctrl_0_ap_start),
        .i_BRAM_addr(fix_address_0_addr_out),
        ...
        .nn_res_in(nn_inference_0_ap_return),
        .o_BRAM_addr(nn_ctrl_0_o_BRAM_addr),
        .o_BRAM_ce(nn_ctrl_0_o_BRAM_ce),
        .o_BRAM_din(nn_ctrl_0_o_BRAM_din),
        .o_BRAM_wr(nn_ctrl_0_o_BRAM_wr),
        .rstb_busy(axi_bram_ctrl_0_bram_rstb_busy));
  design_1_nn_inference_0_1 nn_inference_0
       (.ap_clk(zynq_ultra_ps_e_0_pl_clk0),
        .ap_done(nn_inference_0_ap_done),
        .ap_idle(nn_inference_0_ap_idle),
        .ap_ready(nn_inference_0_ap_ready),
        .ap_return(nn_inference_0_ap_return),
        .ap_rst(not_gate_0_o_out),
        .ap_start(nn_ctrl_0_ap_start),
        .input_img_address0(nn_inference_0_input_img_address0),
        .input_img_ce0(nn_inference_0_input_img_ce0),
        .input_img_q0(axi_bram_ctrl_0_bram_doutb));
